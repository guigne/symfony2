...
class ArticleType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
          ...
          ->add('categories', 'entity', array(
              'class'    => 'RafSiteBundle:Categorie',
              'property' => 'nom',
              'multiple' => true))
        ;

        /**
         * Ajouter l'option queryBuilder pr modifier la liste des objets avec une requête doctrine
         */
        /*$builder->add('article', 'entity', array(
          'class'        => 'RafSiteBundle:Article',
          'property'     => 'titre',
          'querybuilder' => function(\Raf\SiteBundle\Entity\ArticleRepository $r) {
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Raf\SiteBundle\Entity\Article'
        ));
    }

    public function getName()
    {
        return 'raf_sitebundle_articletype';
    }
}
